        ...
        <div className="container w-50">
            ...
            <form className="form-inline "  method="POST" onSubmit={update}>
                ...
                <label htmlFor="Date de naissance">Date de naissance</label>
                    <input type="text" className="form-control" value={date_naissance} required="Veuillez remplir ce champ" id="Date de naissance"  onChange={(e) => setNaissance(e.target.value)} />
                </div>
                <div  className="mb-3"> 
